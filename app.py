...
# =====================================================
# GEO ANALYTICS GLOBAL VARIABLES
# =====================================================
...
if section == "Dashboard Overview":
    ...
    with tab3:
        ...
        st.subheader(
            "🌍 Global Demand Geo Analytics"
        )

        st.info(
            """
            Interactive logistics intelligence
            powered by geo analytics.
            """
        )
    ...
    with tab4:
        ...
        st.warning(
            f"""
            Lowest global demand detected in
            {lowest_city['City']}
            with demand of
            {lowest_city['Demand']:,}.
            """
